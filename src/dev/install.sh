...
wget https://raw.githubusercontent.com/aide-team/aide-utils/refs/heads/main/files/dev/rootCA.pem
...
sudo cp /etc/hosts /etc/hosts.bak && \
    wget -q -O - https://raw.githubusercontent.com/aide-team/aide-utils/refs/heads/main/files/dev/hosts.txt | tr -d '\r' | sudo tee -a /etc/hosts > /dev/null && \
