...
Invoke-WebRequest -Uri "https://raw.githubusercontent.com/angusmf1/aide-utils/refs/heads/main/files/test/rootCA.pem" -OutFile "$env:USERPROFILE\Downloads\rootCA.pem"
